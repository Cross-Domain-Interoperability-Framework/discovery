...
conformsTo
[Required, Repeatable] (object reference). Identifiers for  conformance classes/profiles that the metadata record follows. For CDIF discovery must include ‘https://w3id.org/cdif/discovery/1.0’ and ‘https://w3id.org/cdif/core/1.0’ because conforms to both profiles.
description
